  ...
  return (
    <div className={`min-h-screen font-sans selection:bg-emerald-200 selection:text-emerald-900 transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-12">
          {/* Left Column - Market Prices (Full Width) */}
                      ...
                      <div className="h-40 w-full relative overflow-hidden bg-slate-100">
                        ...
                        />
                         ...
                         <div className="absolute bottom-0 left-0 p-4 w-full">
                            <h3 className="text-lg font-bold text-white mb-1 leading-tight drop-shadow-md group-hover:text-emerald-300 transition-colors">{commodityName}</h3>
