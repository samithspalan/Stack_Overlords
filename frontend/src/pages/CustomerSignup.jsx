        ...
        <BorderAnimatedContainer>
          <div className={`rounded-3xl shadow-2xl border p-6 w-full transition-colors duration-300 ${
            ...
            <div className="text-center mb-4">
              ...
              <h1 className={`text-2xl font-bold mb-1 ${isDark ? 'text-slate-100' : 'text-gray-900'}`}>Customer Signup</h1>
              <p className={`text-sm ${isDark ? 'text-slate-400' : 'text-gray-600'}`}>Start buying fresh produce</p>
            </div>
