...
export default function FarmerSignup() {
  ...
  const handleSignup = (e) => {
    e.preventDefault()
    console.log('Farmer Signup:', { name, email, password, confirmPassword })
    // Navigate to farmer login after signup
    window.location.hash = '#farmer-login'
  }

  return (
    <div className="min-h-screen bg-linear-to-br from-green-50 via-white to-green-50 flex items-center justify-center py-8">
      {/* Logo - Top left */}
      ...
      <a 
        href="#home"
        className="fixed top-6 right-6 z-50 bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg font-medium transition-all duration-300"
      >
        ← Back
      </a>
      ...
      <div className="w-full max-w-md px-4">
        <BorderAnimatedContainer>
          <div className="bg-white rounded-3xl shadow-2xl border border-green-100 p-6 w-full">
            {/* Header */}
            <div className="text-center mb-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900 mb-1">Farmer Signup</h1>
              <p className="text-sm text-gray-600">Create your farm account</p>
            </div>
