import { Sprout, Mail, Lock, ShoppingCart } from 'lucide-react'
...
export default function CustomerLogin() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-teal-50 via-white to-teal-50 flex items-center justify-center">
      ...
      <div className="w-full max-w-md px-4">
        <BorderAnimatedContainer>
          <div className="bg-white rounded-3xl shadow-2xl border border-teal-100 p-10 w-full">
          {/* Header */}
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">Buy fresh produce from farmers</p>
          </div>
